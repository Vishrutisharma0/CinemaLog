...
def register():
    ...
    return render_template(
        "register.html", title="CinemaLog - Register", form=form
    )
...
def login():
    ...
    return render_template("login.html", title="CinemaLog - Login", form=form)
...
def add_movie():
    ...
    return render_template(
        "new_movie.html", title="CinemaLog - Add Movie", form=form
    )
